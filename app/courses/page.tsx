export default function CoursesPage() {
  const courses = [
    ...
    { code: 'ENGG1100', name: 'Professional Engineering', difficulty: 2, rating: 4.1, semester: 'Sem 1', topAssess: '项目报告 60%', assessments: [{ name: '项目报告', pct: 60 }, { name: 'Presentation', pct: 25 }, { name: '个人反思', pct: 15 }], passReq: ['总分 ≥ 50%', '所有作业必须提交'], description: '工程设计入门，团队项目为主。没有考试。', reviews: [{ text: '组队很重要，找靠谱的组员。', score: 4 }, { text: '没有期末考试太舒服了。', score: 5 }] },
    { code: 'CSSE1001', name: 'Introduction to Software Engineering', difficulty: 3, rating: 4.1, semester: 'Sem 1 & 2', topAssess: '作业 60%', assessments: [{ name: '作业x3', pct: 60 }, { name: '期末考试', pct: 40 }], passReq: ['期末考试 ≥ 45%（硬性要求）', '总分 ≥ 50%'], description: 'Python入门，不需要任何编程基础。', reviews: [{ text: '作业要早开始，临近deadline系统会很慢。', score: 4 }, { text: 'A2到A3难度跳升明显。', score: 3 }] },
  ]
