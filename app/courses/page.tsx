export default function CoursesPage() {
  const courses = [
    { code: 'MECH1300', name: 'Engineering Mechanics', difficulty: 4, rating: 3.8, semester: 'Sem 1 & 2', topAssess: '期末考试 50%', assessments: [{ name: '期末考试', pct: 50 }, { name: '期中考试', pct: 25 }, { name: '作业', pct: 25 }], passReq: ['期末考试 ≥ 40%（硬性要求）', '总分 ≥ 50%'], description: '静力学、动力学、材料力学基础。机械工程核心必修课。', reviews: [{ text: '考试题目和tutorial很像，一定要把tutorial全部做完。', score: 4 }, { text: '期中之后难度跳升很大，不要落下进度。', score: 3 }] },
    { code: 'MECH2100', name: 'Mechanics of Solids', difficulty: 4, rating: 3.5, semester: 'Sem 1', topAssess: '期末考试 60%', assessments: [{ name: '期末考试', pct: 60 }, { name: '实验报告', pct: 20 }, { name: '作业', pct: 20 }], passReq: ['期末考试 ≥ 45%（硬性要求）', '总分 ≥ 50%'], description: '应力应变、梁弯曲、扭转分析。MECH1300的延续，需要扎实力学基础。', reviews: [{ text: '实验报告很花时间，早点开始写。', score: 3 }, { text: '期末考试难度中等，历年卷子很有用。', score: 4 }] },
    { code: 'MECH2210', name: 'Fluid Mechanics', difficulty: 4, rating: 3.4, semester: 'Sem 2', topAssess: '期末考试 55%', assessments: [{ name: '期末考试', pct: 55 }, { name: '实验', pct: 20 }, { name: '作业', pct: 25 }], passReq: ['期末考试 ≥ 40%（硬性要求）', '总分 ≥ 50%'], description: '流体静力学、流体动力学、管道流动、边界层理论。公式多，理解原理很重要。', reviews: [{ text: '伯努利方程要烂熟于心，考试必考。', score: 3 }, { text: '实验课很有意思，但报告要认真写。', score: 4 }] },
    { code: 'MECH2300', name: 'Thermodynamics', difficulty: 3, rating: 3.6, semester: 'Sem 1', topAssess: '期末考试 55%', assessments: [{ name: '期末考试', pct: 55 }, { name: '期中测验', pct: 25 }, { name: '作业', pct: 20 }], passReq: ['总分 ≥ 50%'], description: '热力学定律、热力学循环、热机效率。考试可以带公式表，重点是理解何时用哪个公式。', reviews: [{ text: '公式表可以带进考场，把常用公式整理好。', score: 4 }, { text: '作业和考试题型很像，认真做作业。', score: 3 }] },
    { code: 'MECH3200', name: 'Machine Design', difficulty: 4, rating: 3.7, semester: 'Sem 1', topAssess: '项目 40%', assessments: [{ name: '项目', pct: 40 }, { name: '期末考试', pct: 40 }, { name: '作业', pct: 20 }], passReq: ['期末考试 ≥ 40%（硬性要求）', '总分 ≥ 50%'], description: '齿轮、轴、轴承、连接件设计。内容实用，有大量工程设计计算。', reviews: [{ text: '项目很实用，直接用到工程实际，好好做。', score: 4 }, { text: '考试计算量大，要练速度。', score: 3 }] },
    { code: 'MECH3301', name: 'Control Engineering', difficulty: 4, rating: 3.3, semester: 'Sem 2', topAssess: '期末考试 50%', assessments: [{ name: '期末考试', pct: 50 }, { name: '实验', pct: 25 }, { name: '作业', pct: 25 }], passReq: ['期末考试 ≥ 40%（硬性要求）', '总分 ≥ 50%'], description: '传递函数、PID控制、频域分析、稳定性判断。数学要求高，需要扎实的拉普拉斯变换基础。', reviews: [{ text: '最难的一门必修课，Laplace变换一定要熟。', score: 3 }, { text: 'MATLAB仿真部分很有意思，实验课要好好做。', score: 4 }] },
    { code: 'ENGG1100', name: 'Professional Engineering', difficulty: 2, rating: 4.1, semester: 'Sem 1', topAssess: '项目报告 60%', assessments: [{ name: '项目报告', pct: 60 }, { name: 'Presentation', pct: 25 }, { name: '个人反思', pct: 15 }], passReq: ['总分 ≥ 50%', '所有作业必须提交'], description: '工程设计入门，团队项目为主。没有考试，对国际生友好。', reviews: [{ text: '组队很重要，找靠谱的组员。', score: 4 }, { text: '没有期末考试太舒服了。', score: 5 }] },
    { code: 'ENGG4300', name: 'Engineering Project', difficulty: 3, rating: 4.2, semester: 'Sem 1 & 2', topAssess: '论文/报告 60%', assessments: [{ name: '论文/报告', pct: 60 }, { name: 'Presentation', pct: 25 }, { name: '进度汇报', pct: 15 }], passReq: ['总分 ≥ 50%', '必须完成所有里程碑'], description: '毕业设计项目，全年进行。选题很重要，选自己感兴趣的方向。', reviews: [{ text: '选一个好导师比什么都重要，早点联系。', score: 4 }, { text: '时间管理是关键，不要拖到最后一刻。', score: 4 }] },
    { code: 'MATH1051', name: 'Calculus & Linear Algebra I', difficulty: 5, rating: 3.2, semester: 'Sem 1 & 2', topAssess: '期末考试 50%', assessments: [{ name: '期末考试', pct: 50 }, { name: '期中考试', pct: 25 }, { name: '每周测验', pct: 25 }], passReq: ['期末考试 ≥ 40%（硬性要求）', '总分 ≥ 50%'], description: '微积分、线性代数。工科必修，内容密度极高，不能落课。', reviews: [{ text: '绝对不能落课，每周内容都建立在上周基础上。', score: 3 }, { text: 'Tutorial worksheet基本就是考试原题。', score: 4 }] },
    { code: 'MATH1052', name: 'Multivariate Calculus & ODEs', difficulty: 5, rating: 3.1, semester: 'Sem 2', topAssess: '期末考试 50%', assessments: [{ name: '期末考试', pct: 50 }, { name: '期中考试', pct: 25 }, { name: '每周测验', pct: 25 }], passReq: ['期末考试 ≥ 40%（硬性要求）', '总分 ≥ 50%'], description: '多元微积分、常微分方程。MATH1051的延续，难度更高。', reviews: [{ text: 'ODE部分是很多人挂科的地方，重点攻克。', score: 3 }, { text: '和MATH1051一样，tutorial做完就能过。', score: 4 }] },
    { code: 'CSSE1001', name: 'Introduction to Software Engineering', difficulty: 3, rating: 4.1, semester: 'Sem 1 & 2', topAssess: '作业 60%', assessments: [{ name: '作业x3', pct: 60 }, { name: '期末考试', pct: 40 }], passReq: ['期末考试 ≥ 45%（硬性要求）', '总分 ≥ 50%'], description: 'Python入门，不需要任何编程基础。工科生选修热门课。', reviews: [{ text: '作业要早开始，临近deadline系统会很慢。', score: 4 }, { text: 'A2到A3难度跳升明显。', score: 3 }] },
    { code: 'PHYS1001', name: 'Introductory Physics I', difficulty: 3, rating: 3.7, semester: 'Sem 1', topAssess: '期末考试 50%', assessments: [{ name: '期末考试', pct: 50 }, { name: '实验', pct: 20 }, { name: '在线测验', pct: 30 }], passReq: ['总分 ≥ 50%'], description: '力学、波动、热学基础。对机械工程学生比较容易，和MECH1300内容有重叠。', reviews: [{ text: '在线测验可以多次提交，好好利用。', score: 4 }, { text: '实验报告格式要按模板来，扣分很严。', score: 3 }] },
  ]
